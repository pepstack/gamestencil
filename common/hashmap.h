...
/**
 * Hashing function for int
 */
extern int get_int_hash(void * intval, int hashsize);

/**
 * Hashing function for a string
 */
extern int get_string_hash(const char* keystring, int keystrlen, int hashsize);
 ...
 * Return char * as key
 */
extern char* ptr_addr_to_key(void_ptr ptr, char* key);
 ...
 */
extern void hashmap_clear(hmap_t in, hmap_callback_func fnFreeValue, void_ptr arg);
