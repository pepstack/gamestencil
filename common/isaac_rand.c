...
void randctx_init(randctx *ctx, word time_as_seed)
{
    word i;
    ub4 a, b, c, d, e, f, g, h;
    ub4 *m, *r;
...
void randctx64_init(randctx64 *ctx, word time_as_seed)
{
    word i;
    ub8 a,b,c,d,e,f,g,h;
    ub8 *mm, *r;
...
static void usage()
{
    ...
    randctx_init(&ctx, RAND_TRUE);

    randctx64_init(&ctx64, RAND_TRUE);
